...
ALTER TABLE "weekly_meetings" ADD CONSTRAINT "weekly_meetings_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;-- Updated on Sat Dec 27 06:03:32 AM UTC 2025
