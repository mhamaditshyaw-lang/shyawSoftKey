...
export const MENU_PARTITIONS: MenuPartition[] = [
  {
    ...
    items: [
      { labelKey: "menu_manageTasks", label: "Manage Tasks", path: "/manager-todos", iconName: "CheckSquare", description: "Manager todo list overview" },
      ...
      { labelKey: "menu_itSupport", label: "IT Helpdesk", path: "/it-support", iconName: "Wrench", description: "IT helpdesk requests and tasks" },
