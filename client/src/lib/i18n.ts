...
const resources = {
  ...
  ku: {
    translation: {
      ...
      dateFilter: "پاڵاوتنی بەرواری",
      every30s: "هەر ٣٠ چرکەیەک",
      clearFilters: "پاڵاوتنەکان پاکبکە",
      showing: "نیشاندان",
      reviews: "پێداچونان",
      noInterviewRequests: "هیچ داواکاری کۆبوونەوە نەدۆزرایەوە",
