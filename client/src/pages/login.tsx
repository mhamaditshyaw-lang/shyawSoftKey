    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-800 flex-col justify-center items-center p-8 lg:p-12 relative overflow-hidden animate-slide-in">
        ...
        <div className="text-center text-white relative z-10 animate-fade-in">
          ...
          <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-white to-indigo-100 bg-clip-text text-transparent">Administration Shyaw System</h1>
          <p className="text-xl text-indigo-100 mb-2">Professional Administration Platform</p>
          <p className="text-indigo-200">Secure and efficient administrative management</p>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-8 bg-gradient-to-br from-indigo-50 to-white md:bg-none">
          ...
          {isLogin ? (
            <Card className="border-indigo-100 shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse-hover">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-3xl text-indigo-800">Welcome Back</CardTitle>
                <CardDescription className="text-indigo-600">Sign in to Administration Shyaw System</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-indigo-100 shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse-hover">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-3xl text-indigo-800">Create Account</CardTitle>
                <CardDescription className="text-indigo-600">Join Administration Shyaw System</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="username" className="text-indigo-700">Username</Label>
                    <Input
                      id="username"
                      type="text"
                      placeholder="johndoe"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="role" className="text-indigo-700">Requested Role</Label>
